/* ============================================================
   ...
   ------------------------------------------------------------
   โครง (ตรงกับ V2):
   - "ข่าวล่าสุด"  : 3 ข่าวล่าสุด (เด่น) เรียงใหม่ → เก่า ตาม sourcePublishedAt
   - "ข่าวเพิ่มเติม": ข่าวลำดับ 4 เป็นต้นไป โหลดทีละ 6 ข่าว ผ่านปุ่ม
   กฎ:
   - ข่าวทั้งหมดมาจาก API (เฉพาะ published, เรียงตาม sourcePublishedAt)
   - ไม่ hardcode รายการข่าว
...
(function () {
  ...
  const state = {
    ...
    latestLoaded: false,
    moreOffset: LATEST_COUNT,
    hasMore: false,
    total: 0,
    shownIds: new Set(), // track id ที่แสดงแล้ว (defense-in-depth)
  };
  ...
  function renderLatestError() {
    ...
    el.innerHTML = `<div class="state state--wide">
      ...
      <p>เกิดข้อผิดพลาดในการโหลดข่าว กรุณาลองอีกครั้ง</p>
