...
const file = path.join(__dirname, 'Version-2-Gold-Trading/signal.js');

let code = fs.readFileSync(file, 'utf8');

// Find the line where we want to truncate
const searchStr = 'document.addEventListener("DOMContentLoaded", render);';
const idx = code.indexOf(searchStr);

if (idx !== -1) {
    // Keep everything BEFORE the original render bind
...
fs.writeFileSync(file, code + newLogic);
console.log("Successfully rebuilt signal.js!");
